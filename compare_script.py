...
old_fit_dir = '../default/fit/'
old_img_dir = '../default/image/'
old_img_root = 'c0084'

new_fit_dir = '../Smooth_1/fit/'
new_img_dir = '../Smooth_1/image/'
new_img_root = 'c0084'
mode = 'variable'
...
compare_fvu_on_star(old_fit_dir, new_fit_dir, old_img_dir, new_img_dir, old_img_root,new_img_root, mode, star_name, star_pos)
