...
one_fit_dir = '../POOR-run/fit/'
one_img_dir = '../POOR-run/image/'
one_img_root = 'c0084'
...
#compare_fvu_on_three_star(one_fit_dir, two_fit_dir, three_fit_dir, one_img_dir, two_img_dir, three_img_dir, one_img_root, two_img_root, three_img_root, mode, star_name, star_pos)
